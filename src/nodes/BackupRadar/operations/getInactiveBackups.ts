...
export async function executeGetInactiveBackups(
  ...
  if (returnAll) {
    ...
    do {
      ...
      const pageResponse = (await requestBackupRadar.call(ctx, 'GET', '/backups/inactive', { qs })) as IDataObject;
  ...
  return requestBackupRadar.call(ctx, 'GET', '/backups/inactive', { qs });
}
